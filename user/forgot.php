   ...
   if(isset($_POST["email"]) && (!empty($_POST["email"]))) {
      ...
      if($response!="") {
         ...
         if($result) {
            ...
            $output.='<p>-------------------------------------------------------------</p>';
            $output.='<p><a href="https://test.com.www.carpass.gr/user/reset-password.php?key='.$key.'&email='.$email.'&type='.$type.'&action=reset" target="_blank">
               https://test.com.www.carpass.gr/user/reset-password.php?key='.$key.'&email='.$email.'&type='.$type.'&action=reset</a></p>';    
            $output.='<p>-------------------------------------------------------------</p>';
